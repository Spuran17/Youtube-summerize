...
nltk.download('punkt')#checks punkt is downloaded
nltk.download('stopwords')#checks stopwords is downloaded
nltk.download('wordnet')#checks wordnet is downloaded
